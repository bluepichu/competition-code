...
// An implementation of a Binary-Indexed Tree, or BIT
// The default behavior performs range queries, in which a contiguous range of numbers is summed.
...
public class BIT{
	...
	// Arguments:
	//   int[] values - the values from which to create the BIT
	public BIT(int[] values){
